...
> Adam, LR schedulers, gradient clipping
...
### Prerequisites
- Completion of prior projects (01-36)
...
### Setup
```bash
cd project-37-advanced-training
```
...
### Running Tests
```bash
pytest test/test_project_37.py -v
```
...
- [Project 36](../project-36-*/): Previous project
- [Project 38](../project-38-*/): Next project
