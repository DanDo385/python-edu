...
### Prerequisites
- Completion of prior projects (01-06)
...
### Running Tests
```bash
pytest test/test_project_07.py -v
```
...
- [Project 06](../project-06-*/): Previous project
- [Project 08](../project-08-*/): Next project
