...
### Prerequisites
- Completion of prior projects (01-04)
...
### Setup
```bash
cd project-05-dictionaries-sets
```
...
### Running Tests
```bash
pytest test/test_project_05.py -v
```
...
- [Project 04](../project-04-*/): Previous project
- [Project 06](../project-06-*/): Next project
