...
### Prerequisites
- Completion of prior projects (01-48)
...
### Running Tests
```bash
pytest test/test_project_49.py -v
```
...
- [Project 48](../project-48-*/): Previous project
- [Project 50](../project-50-*/): Next project
