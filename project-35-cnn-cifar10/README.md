...
### Prerequisites
- Completion of prior projects (01-34)
...
### Running Tests
```bash
pytest test/test_project_35.py -v
```
...
- [Project 34](../project-34-*/): Previous project
- [Project 36](../project-36-*/): Next project
