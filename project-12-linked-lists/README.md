...
> Nodes, insertion, deletion, reversal
...
### Prerequisites
- Completion of prior projects (01-11)
...
### Running Tests
```bash
pytest test/test_project_12.py -v
```
...
- [Project 11](../project-11-*/): Previous project
- [Project 13](../project-13-*/): Next project
