...
> nn.Embedding, LSTM, IMDB sentiment
...
### Prerequisites
- Completion of prior projects (01-35)
...
### Setup
```bash
cd project-36-embeddings-text-classification
```
...
### Running Tests
```bash
pytest test/test_project_36.py -v
```
...
- [Project 35](../project-35-*/): Previous project
- [Project 37](../project-37-*/): Next project
