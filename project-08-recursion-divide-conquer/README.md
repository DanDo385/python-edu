...
> Factorial, Fibonacci, GCD, binary search
...
### Prerequisites
- Completion of prior projects (01-07)
...
### Setup
```bash
cd project-08-recursion-divide-conquer
```
...
### Running Tests
```bash
pytest test/test_project_08.py -v
```
...
- [Project 07](../project-07-*/): Previous project
- [Project 09](../project-09-*/): Next project
