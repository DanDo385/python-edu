...
> Encoder-decoder, attention, translation
...
### Prerequisites
- Completion of prior projects (01-39)
...
### Setup
```bash
cd project-40-seq2seq-attention
```
...
### Running Tests
```bash
pytest test/test_project_40.py -v
```
...
- [Project 39](../project-39-*/): Previous project
- [Project 41](../project-41-*/): Next project
