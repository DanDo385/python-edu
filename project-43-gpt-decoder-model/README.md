...
> GPT architecture, causal masking
...
### Prerequisites
- Completion of prior projects (01-42)
...
### Setup
```bash
cd project-43-gpt-decoder-model
```
...
### Running Tests
```bash
pytest test/test_project_43.py -v
```
...
- [Project 42](../project-42-*/): Previous project
- [Project 44](../project-44-*/): Next project
