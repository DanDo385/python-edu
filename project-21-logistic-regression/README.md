...
> Sigmoid, cross-entropy, classification
...
### Prerequisites
- Completion of prior projects (01-20)
...
### Setup
```bash
cd project-21-logistic-regression
```
...
### Running Tests
```bash
pytest test/test_project_21.py -v
```
...
- [Project 20](../project-20-*/): Previous project
- [Project 22](../project-22-*/): Next project
