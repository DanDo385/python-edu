...
### Prerequisites
- Completion of prior projects (01-12)
...
### Running Tests
```bash
pytest test/test_project_13.py -v
```
...
- [Project 12](../project-12-*/): Previous project
- [Project 14](../project-14-*/): Next project
