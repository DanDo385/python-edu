...
### Prerequisites
- Completion of prior projects (01-45)
...
### Setup
```bash
cd project-46-llm-inference-decoding
```
...
### Running Tests
```bash
pytest test/test_project_46.py -v
```
...
- [Project 45](../project-45-*/): Previous project
- [Project 47](../project-47-*/): Next project
