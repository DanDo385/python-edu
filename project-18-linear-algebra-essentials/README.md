...
> Dot products, solving Ax=b, projections
...
### Prerequisites
- Completion of prior projects (01-17)
...
### Setup
```bash
cd project-18-linear-algebra-essentials
```
...
### Running Tests
```bash
pytest test/test_project_18.py -v
```
...
- [Project 17](../project-17-*/): Previous project
- [Project 19](../project-19-*/): Next project
