...
### Prerequisites
- Completion of prior projects (01-08)
...
### Setup
```bash
cd project-09-searching-algorithms
```
...
### Running Tests
```bash
pytest test/test_project_09.py -v
```
...
- [Project 08](../project-08-*/): Previous project
- [Project 10](../project-10-*/): Next project
