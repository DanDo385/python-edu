...
### Prerequisites
- Completion of prior projects (01-46)
...
### Setup
```bash
cd project-47-model-quantization
```
...
### Running Tests
```bash
pytest test/test_project_47.py -v
```
...
- [Project 46](../project-46-*/): Previous project
- [Project 48](../project-48-*/): Next project
