...
### Prerequisites
- Completion of prior projects (01-05)
...
### Running Tests
```bash
pytest test/test_project_06.py -v
```
...
- [Project 05](../project-05-*/): Previous project
- [Project 07](../project-07-*/): Next project
