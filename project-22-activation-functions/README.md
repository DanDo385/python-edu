...
### Prerequisites
- Completion of prior projects (01-21)
...
### Setup
```bash
cd project-22-activation-functions
```
...
### Running Tests
```bash
pytest test/test_project_22.py -v
```
...
- [Project 21](../project-21-*/): Previous project
- [Project 23](../project-23-*/): Next project
