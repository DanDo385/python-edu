...
> Train GPT on WikiText-2, perplexity
...
### Prerequisites
- Completion of prior projects (01-44)
...
### Setup
```bash
cd project-45-babygpt-training
```
...
### Running Tests
```bash
pytest test/test_project_45.py -v
```
...
- [Project 44](../project-44-*/): Previous project
- [Project 46](../project-46-*/): Next project
