...
> Comp graphs, reverse-mode AD, .backward()
...
### Prerequisites
- Completion of prior projects (01-23)
...
### Running Tests
```bash
pytest test/test_project_24.py -v
```
...
- [Project 23](../project-23-*/): Previous project
- [Project 25](../project-25-*/): Next project
