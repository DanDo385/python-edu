...
> Matrix ops, performance, @ operator
...
### Prerequisites
- Completion of prior projects (01-16)
...
### Running Tests
```bash
pytest test/test_project_17.py -v
```
...
- [Project 16](../project-16-*/): Previous project
- [Project 18](../project-18-*/): Next project
