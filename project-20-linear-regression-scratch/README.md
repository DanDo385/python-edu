...
### Prerequisites
- Completion of prior projects (01-19)
...
### Setup
```bash
cd project-20-linear-regression-scratch
```
...
### Running Tests
```bash
pytest test/test_project_20.py -v
```
...
- [Project 19](../project-19-*/): Previous project
- [Project 21](../project-21-*/): Next project
