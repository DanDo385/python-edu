...
> torch.Tensor, GPU, device management
...
### Prerequisites
- Completion of prior projects (01-30)
...
### Setup
```bash
cd project-31-pytorch-tensors-gpu
```
...
### Running Tests
```bash
pytest test/test_project_31.py -v
```
...
- [Project 30](../project-30-*/): Previous project
- [Project 32](../project-32-*/): Next project
