...
> nn.Module, custom layers, forward()
...
### Prerequisites
- Completion of prior projects (01-32)
...
### Running Tests
```bash
pytest test/test_project_33.py -v
```
...
- [Project 32](../project-32-*/): Previous project
- [Project 34](../project-34-*/): Next project
