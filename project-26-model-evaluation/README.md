...
> Train/val/test, metrics, confusion matrix
...
### Prerequisites
- Completion of prior projects (01-25)
...
### Setup
```bash
cd project-26-model-evaluation
```
...
### Running Tests
```bash
pytest test/test_project_26.py -v
```
...
- [Project 25](../project-25-*/): Previous project
- [Project 27](../project-27-*/): Next project
