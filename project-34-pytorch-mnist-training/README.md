...
> DataLoader, training loop, checkpoints
...
### Prerequisites
- Completion of prior projects (01-33)
...
### Setup
```bash
cd project-34-pytorch-mnist-training
```
...
### Running Tests
```bash
pytest test/test_project_34.py -v
```
...
- [Project 33](../project-33-*/): Previous project
- [Project 35](../project-35-*/): Next project
