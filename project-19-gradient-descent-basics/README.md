...
> 1D optimization, learning rate, convergence
...
### Prerequisites
- Completion of prior projects (01-18)
...
### Setup
```bash
cd project-19-gradient-descent-basics
```
...
### Running Tests
```bash
pytest test/test_project_19.py -v
```
...
- [Project 18](../project-18-*/): Previous project
- [Project 20](../project-20-*/): Next project
