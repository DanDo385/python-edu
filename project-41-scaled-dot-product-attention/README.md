...
### Prerequisites
- Completion of prior projects (01-40)
...
### Setup
```bash
cd project-41-scaled-dot-product-attention
```
...
### Running Tests
```bash
pytest test/test_project_41.py -v
```
...
- [Project 40](../project-40-*/): Previous project
- [Project 42](../project-42-*/): Next project
