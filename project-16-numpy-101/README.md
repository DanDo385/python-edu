...
### Prerequisites
- Completion of prior projects (01-15)
...
### Running Tests
```bash
pytest test/test_project_16.py -v
```
...
- [Project 15](../project-15-*/): Previous project
- [Project 17](../project-17-*/): Next project
