...
### Prerequisites
- Completion of prior projects (01-47)
...
### Running Tests
```bash
pytest test/test_project_48.py -v
```
...
- [Project 47](../project-47-*/): Previous project
- [Project 49](../project-49-*/): Next project
