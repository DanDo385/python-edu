...
> MNIST classifier in pure NumPy
...
### Prerequisites
- Completion of prior projects (01-29)
...
### Setup
```bash
cd project-30-mnist-numpy-capstone
```
...
### Running Tests
```bash
pytest test/test_project_30.py -v
```
...
- [Project 29](../project-29-*/): Previous project
- [Project 31](../project-31-*/): Next project
