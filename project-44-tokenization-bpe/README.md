...
> BPE, SentencePiece, vocab building
...
### Prerequisites
- Completion of prior projects (01-43)
...
### Setup
```bash
cd project-44-tokenization-bpe
```
...
### Running Tests
```bash
pytest test/test_project_44.py -v
```
...
- [Project 43](../project-43-*/): Previous project
- [Project 45](../project-45-*/): Next project
