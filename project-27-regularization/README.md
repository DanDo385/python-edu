...
### Prerequisites
- Completion of prior projects (01-26)
...
### Running Tests
```bash
pytest test/test_project_27.py -v
```
...
- [Project 26](../project-26-*/): Previous project
- [Project 28](../project-28-*/): Next project
