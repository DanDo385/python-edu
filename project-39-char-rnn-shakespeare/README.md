...
### Prerequisites
- Completion of prior projects (01-38)
...
### Setup
```bash
cd project-39-char-rnn-shakespeare
```
...
### Running Tests
```bash
pytest test/test_project_39.py -v
```
...
- [Project 38](../project-38-*/): Previous project
- [Project 40](../project-40-*/): Next project
