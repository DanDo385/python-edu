...
### Prerequisites
- Completion of prior projects (01-01)
...
### Setup
```bash
cd project-02-control-flow-loops
```
...
### Running Tests
```bash
pytest test/test_project_02.py -v
```
...
- [Project 01](../project-01-*/): Previous project
- [Project 03](../project-03-*/): Next project
