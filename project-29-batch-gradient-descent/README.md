...
> SGD vs batch vs mini-batch, momentum
...
### Prerequisites
- Completion of prior projects (01-28)
...
### Setup
```bash
cd project-29-batch-gradient-descent
```
...
### Running Tests
```bash
pytest test/test_project_29.py -v
```
...
- [Project 28](../project-28-*/): Previous project
- [Project 30](../project-30-*/): Next project
