...
> Grid search, LR schedules, validation
...
### Prerequisites
- Completion of prior projects (01-27)
...
### Setup
```bash
cd project-28-hyperparameter-tuning
```
...
### Running Tests
```bash
pytest test/test_project_28.py -v
```
...
- [Project 27](../project-27-*/): Previous project
- [Project 29](../project-29-*/): Next project
