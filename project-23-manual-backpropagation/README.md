...
> Chain rule, gradient flow, 2-layer net
...
### Prerequisites
- Completion of prior projects (01-22)
...
### Setup
```bash
cd project-23-manual-backpropagation
```
...
### Running Tests
```bash
pytest test/test_project_23.py -v
```
...
- [Project 22](../project-22-*/): Previous project
- [Project 24](../project-24-*/): Next project
