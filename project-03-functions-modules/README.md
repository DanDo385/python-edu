...
> Functions, scope, imports, docstrings
...
### Prerequisites
- Completion of prior projects (01-02)
...
### Setup
```bash
cd project-03-functions-modules
```
...
### Running Tests
```bash
pytest test/test_project_03.py -v
```
...
- [Project 02](../project-02-*/): Previous project
- [Project 04](../project-04-*/): Next project
