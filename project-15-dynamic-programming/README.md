...
### Prerequisites
- Completion of prior projects (01-14)
...
### Setup
```bash
cd project-15-dynamic-programming
```
...
### Running Tests
```bash
pytest test/test_project_15.py -v
```
...
- [Project 14](../project-14-*/): Previous project
- [Project 16](../project-16-*/): Next project
