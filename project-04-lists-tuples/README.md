...
> Sequences, slicing, comprehensions
...
### Prerequisites
- Completion of prior projects (01-03)
...
### Running Tests
```bash
pytest test/test_project_04.py -v
```
...
- [Project 03](../project-03-*/): Previous project
- [Project 05](../project-05-*/): Next project
