...
> LIFO/FIFO, balanced parentheses, BFS
...
### Prerequisites
- Completion of prior projects (01-10)
...
### Running Tests
```bash
pytest test/test_project_11.py -v
```
...
- [Project 10](../project-10-*/): Previous project
- [Project 12](../project-12-*/): Next project
