...
### Prerequisites
- Completion of prior projects (01-09)
...
### Setup
```bash
cd project-10-sorting-algorithms
```
...
### Running Tests
```bash
pytest test/test_project_10.py -v
```
...
- [Project 09](../project-09-*/): Previous project
- [Project 11](../project-11-*/): Next project
