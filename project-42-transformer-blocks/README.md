...
### Prerequisites
- Completion of prior projects (01-41)
...
### Setup
```bash
cd project-42-transformer-blocks
```
...
### Running Tests
```bash
pytest test/test_project_42.py -v
```
...
- [Project 41](../project-41-*/): Previous project
- [Project 43](../project-43-*/): Next project
