...
> Pretrained ResNet, fine-tuning, freezing
...
### Prerequisites
- Completion of prior projects (01-37)
...
### Setup
```bash
cd project-38-transfer-learning
```
...
### Running Tests
```bash
pytest test/test_project_38.py -v
```
...
- [Project 37](../project-37-*/): Previous project
- [Project 39](../project-39-*/): Next project
